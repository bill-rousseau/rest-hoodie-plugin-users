(function() {
	...
	hoodieAdmin.listPlans = function() {
		return hoodieAdmin.request('get', 'http://127.0.0.1:6011/_api/_plugins/stripe/_api', {
	  		headers: {
	  			'Content-Type': 'application/json'
	  		},
...
(function() {
  ...
  Users.UsersView = (function(_super) {
    ...
    UsersView.prototype.events = {
      ...
      'submit form.listPlans': 'listPlans',
	...
	UsersView.prototype.listPlans = function(event) {
	    ...
	    .done(function(data) {
	    	console.log(data);
	    	$btn.attr('disabled', null);
			return $form.find('.submitMessage').text("List printed");
	    });
	};
...
function program2(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + ", please select a plan</label>\n    <button class=\"btn\" type=\"submit\">See all plans</button>\n    <span class=\"submitMessage\"></span>\n  </form>\n  <h2>Edit Plan for '";
  if (helper = helpers.id) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.id); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "'</h2>\n  <form class=\"updatePlan\" data-id=\"";
  if (helper = helpers.id) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.id); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "\">\n    <fieldset>\n      <label for=\"input-3\">";
...
function program24(depth0,data) {
  ...
  buffer += "  <script type=\"text/javascript\" src=\"https://js.stripe.com/v2/\"></script>\n  <div class=\"container\">\n  <h1>Users</h1>\n  ";
